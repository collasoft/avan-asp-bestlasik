<%
	...
	query_filde		= "*"
	query_Tablename	= "faq"
	query_where		= " intSeq > 0 and f_divi = 1 "
...
<div class="top_tabwrap">
  <ul>
	<li <%If Request.QueryString("bunryu") = "" Then%>class="on"<%End if%>><a href="?lasik=I101">전체</a></li>
	<li <%If Request.QueryString("bunryu") = "a" Then%>class="on"<%End if%>><a href="?lasik=I101&bunryu=a">진료 및 수술</a></li>
	<li <%If Request.QueryString("bunryu") = "b" Then%>class="on"<%End if%>><a href="?lasik=I101&bunryu=b">비용</a></li>
	<li <%If Request.QueryString("bunryu") = "c" Then%>class="on"<%End if%>><a href="?lasik=I101&bunryu=c">기타</a></li>
  </ul>
</div>
		...
		<div class="faq_content">
		  <table>
		    <tr>
			  ...
			  <td class="txt"><%=rs2("f_contents")%></td>
		    </tr>
		  </table>
		</div>
	  </li>	
