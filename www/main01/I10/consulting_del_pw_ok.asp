...
Dim tablename
tablename = "counsel"
Const UploadFolder = "/upload/counsel"
...
Call jsAlertMsgUrl("삭제 되었습니다.", "/main01/sub.asp?lasik=I102&page="&request.QueryString("page")&"&gum1="&request.QueryString("gum1")&"&gum2="&request.QueryString("gum2"))
