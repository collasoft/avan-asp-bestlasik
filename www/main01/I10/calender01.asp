...
//			return;
			if((year + "-" + month + "-" + day) >= thsday) {
				$(location).attr("href", "?lasik=I107&year=" + year + "&month=" + month + "&day=" + day);
			} else {
...
//			var day = ++dayCount;
//			console.log(month);
			if (dayCount < 10) { dayCount = "0" + dayCount; }
/*
			if((year + "-" + month + "-" + dayCount) < thsday) {
				console.log(year + "-" + month + "-" + dayCount);
				$tdDay.eq(i).parent().css("background-color", "#f4f4f4")
			}
*/
        }
