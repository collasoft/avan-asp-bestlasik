...
//			$("#cmonth").val(thsday.substr(0,4));
			...
			$.ajax({
				type: "POST",
				url: "/main01/I10/bxm_ajax_reserve.asp",
				dataType: "html",
...
<form name="frmRequestForm" method="post" onSubmit="return frmRequestForm_Submit(this);" action="/main01/I10/bxm_diagnosis_write_ok.asp">
