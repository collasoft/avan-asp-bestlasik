<div class="consulting"> 
  <div class="inner">
	...
	<form name="frmRequestForm" method="post" onSubmit="return frmRequestForm_Submit(this);" action="/main01/I10/consulting_pw_ok.asp?intSeq=<%=request("intSeq")%>&page=<%=request("page")%>&gum1=<%=request("gum1")%>&gum2=<%=request("gum2")%>">
	<div class="pw_input">
