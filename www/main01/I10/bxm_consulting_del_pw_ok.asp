...
Else 
	...
	Call jsAlertMsgUrl("삭제 되었습니다.", "/main01/sub.asp?lasik=I102&nPage="&request.QueryString("nPage")&"&gum1="&request.QueryString("gum1")&"&gum2="&request.QueryString("gum2"))
End if
%>