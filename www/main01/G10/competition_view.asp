...
<!--e: 현재 페이지에만 적용할 특정 스크립트 추가영역-->
 <!-- Demo styles -->
  ...
  #view_popup .swiper-container{overflow:hidden; position:relative; height:100%;}
...
<%
	...
	query_where		= " 1 = 1 "
	query_where = query_where & " AND C_SEQ = '"&request.QueryString("cSeq")&"'"
	...
	<section id="sub_content">
		<div class="inner">
			<div class="event_title_box"> 
				<p class="title"><%=rs2("C_TITLE")%></p>
			  </div>
			<div #swiperRef="" class="swiper-container mySwiper">
				<div class="swiper-wrapper">
					<%If cImg1 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg1%>"></div></div>
					<%End If%>
					<%If cImg2 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg2%>"></div></div>
					<%End If%>
					<%If cImg3 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg3%>"></div></div>
					<%End If%>
					<%If cImg4 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg4%>"></div></div>
					<%End If%>
					<%If cImg5 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg5%>"></div></div>
					<%End If%>
					<%If cImg6 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg6%>"></div></div>
					<%End If%>
					<%If cImg7 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg7%>"></div></div>
					<%End If%>
					<%If cImg8 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg8%>"></div></div>
					<%End If%>
					<%If cImg9 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg9%>"></div></div>
					<%End If%>
					<%If cImg10 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg10%>"></div></div>
					<%End If%>
					<%If cImg11 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg11%>"></div></div>
					<%End If%>
					<%If cImg12 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg12%>"></div></div>
					<%End If%>
					<%If cImg13 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg13%>"></div></div>
					<%End If%>
					<%If cImg14 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg14%>"></div></div>
					<%End If%>
					<%If cImg15 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg15%>"></div></div>
					<%End If%>
					<%If cImg16 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg16%>"></div></div>
					<%End If%>
					<%If cImg17 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg17%>"></div></div>
					<%End If%>
					<%If cImg18 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg18%>"></div></div>
					<%End If%>
					<%If cImg19 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg19%>"></div></div>
					<%End If%>
					<%If cImg20 <> "" Then%>
					<div class="swiper-slide"><div class="img_box"><img src="/upload/competition/<%=cImg20%>"></div></div>
					<%End If%>
				</div>
				<div class="page">
			...
			<div class="viewbtn_wrap">
				...
				<input type="button" value="목록" class="btn02" onclick="self.location.href = '?lasik=G109&page=<%=request.querystring("page")%>&gum1=<%=request("gum1")%>&gum2=<%=request("gum2")%>';" />
