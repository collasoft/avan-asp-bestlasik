...
Function menu3(lasik)
  ...
  ElseIf Left(lasik,4) = "C101" Then
    Response.write "라식이란"
  ElseIf lasik = "C102" Or lasik = "C103" Or lasik = "C104" Or lasik = "C105" Then
    Response.write "라식의 종류"
  ElseIf Left(lasik,4) = "D101" Then
    Response.write "라섹이란"
  ElseIf lasik = "D102" or lasik = "D103" Or lasik = "D104" Or lasik = "D105" Or lasik = "D106" Then
    Response.write "라섹의 종류"
  ElseIf Left(lasik,4) = "E101" Then
    Response.write "신세계렌즈삽입술이란"
  ElseIf lasik = "E102" Or lasik = "E103" Or lasik = "E104" Or lasik = "E105" Or lasik = "E106" Then
    Response.write "렌즈의 종류"
  ElseIf Left(lasik,4) = "F101" Then
    Response.write "노안이란"
      ElseIf Left(lasik,4) = "F1013" Then
...
<%End if%>
  	...
  	<div class="call_dropDown">
		...
		<ul>
			...
			<li><a href="http://bestlasik.solutionhosting.co.kr/main01/sub.asp?lasik=I106">진료예약</a></li>
		</ul>
  	</div>
  </div>
  <div class="logo">
  ...
  <ul class="gnb">
    <li class="dp1"><a href="sub.asp?lasik=A101">병원소개</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=B101">신세계스마일</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=C101">라식</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=D101">라섹</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=E101">렌즈삽입술</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=F101">노안라식</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=G101">정보센터</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=H101&gubun=a">수술후기</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
    ...
    <li class="dp1"><a href="sub.asp?lasik=I101">상담및예약</a><span class="line"></span>
	  <div class="dp2">
	    <ul>
...
<div class="full_menu">
  <div class="inner">
     <ul class="full_menu_ul">
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=A101">병원소개</a></li>
          <li><a href="sub.asp?lasik=A101">비전</a></li>
          <li><a href="sub.asp?lasik=A102">의료진소개</a></li>
          <li><a href="sub.asp?lasik=A103">둘러보기</a></li>
          <li><a href="sub.asp?lasik=A104">오시는길</a></li>
      ...
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=B101">신세계스마일</a></li>
          <li><a href="sub.asp?lasik=B102">왜 신세계안과일까?</a></li>
          <li><a href="sub.asp?lasik=B101">신세계스마일이란</a></li>          
        </ul>
      </li>
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=C101">라식</a></li>
          <li><a href="sub.asp?lasik=C101">신세계라식이란</a></li>
          <li><a href="sub.asp?lasik=C102">신세계라식의 종류</a></li>
        </ul>
      </li>
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=D101">라섹</a></li>
          <li><a href="sub.asp?lasik=D101">신세계라섹이란</a></li>
          <li><a href="sub.asp?lasik=D102">신세계라섹의 종류</a></li>
        </ul>
      </li>
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=E101">렌즈삽입술</a></li>
          <li><a href="sub.asp?lasik=E101">신세계렌즈삽입술이란</a></li>
          <li><a href="sub.asp?lasik=E102">렌즈의 종류</a></li>
        </ul>
      </li>
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=F101">노안라식</a></li>
          <li><a href="sub.asp?lasik=F101">노안이란</a></li>
      ...
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=G101">정보센터</a></li>
          <li><a href="sub.asp?lasik=G101">이벤트소식</a></li>
          <li><a href="sub.asp?lasik=G103">공지사항</a></li>
          <li><a href="sub.asp?lasik=G105">보도자료</a></li>
          <li><a href="sub.asp?lasik=G107">협력업체</a></li>
      ...
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=H101&gubun=a">수술후기</a></li>
          <li><a href="sub.asp?lasik=H101&gubun=a">고객수술후기</a></li>
          <li><a href="sub.asp?lasik=H104&gubun=b">의료진/직원 수술후기</a></li>
        </ul>
      </li>
      <li class="full_dp1">
        <ul>
          <li class="tit"><a href="sub.asp?lasik=I101">상담및예약</a></li>
          <li><a href="sub.asp?lasik=I101">자주하는 질문</a></li>
          <li><a href="sub.asp?lasik=I102">진료상담</a></li>
          <li><a href="sub.asp?lasik=I106">검사/진료예약</a></li>
        </ul>
