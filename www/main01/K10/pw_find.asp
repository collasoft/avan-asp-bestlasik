<div class="sub_join">
  <div class="inner">
	<div class="top_tabwrap mb50"> 
	  <ul> 
		<li><a href="?lasik=K102">아이디찾기</a></li>
		<li class="on"><a href="?lasik=K104">비밀번호찾기</a></li>
	  </ul>
	</div>
	<div class="top_txt02"> 
	...
	<div class="input_form">
	  <form name="loginform" onsubmit="return submit_check(this);" action="/main01/K10/pw_findok.asp" method="post">
	  <table>
		<tbody> 
		  <tr>
			<th>아이디</th>
			<td class="id"><input type="text" placeholder="아이디를 입력해 주세요." name="id" /></td>
		  </tr>
		  <tr>
			<th>이름</th>
	  ...
	  <div class="subbtn_wrap">
		...
		<input type="button" value="비밀번호찾기" class="btn02" onclick="this.form.onsubmit();" />
	  </div>
	  </form>
    </div>
  </div>
