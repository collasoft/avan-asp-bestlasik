...
<div class="sub_login">
  <div class="inner">
	<div class="login_box">
	  ...
	  <form name="loginform" onsubmit="return submit_check(this);" action="/main01/K10/login_check.asp" method="post" class="login_input">
	  ...
	  <div class="login_btn"> 
		<a href="sub.asp?lasik=J101">회원가입 바로가기</a>
		<a href="sub.asp?lasik=K102">아이디 / 비밀번호 찾기</a>
	  </div>
	</div>
	<!-- 2022/12/13 숨김요청
    <div class="login_box">
...
function remCookie()
{
 ...
 //document.form.email.value = GetCookie("theEmail");
  ...
  function SNSLogin(sns){
	...
	var popup = window.open("/main01/K10/gateway.asp?sns="+sns+"&strBackUrl=<%=server.urlencode(request.querystring("strBackUrl"))%>","sns","resizable=false,width=880,height=720, top=" + top + ", left=" + left);
  }
