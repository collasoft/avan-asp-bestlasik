...
<script>
	var review_tab1,review_tab2,review_tab3,review_tab4,review_tab5,review_tab6;
...
<div id="A_Wrap">
	...
	<div id="A_Header">
		<!-- #include file="_inc/header_20241017.asp" -->
	</div><!-- #A_Header 끝 -->
			...
			<div class="main_review">
				<div class="inner">
					<div class="titArea">
						...
						<ul class="tabs">
	        				<li>
	        					<a href="#tab6" onClick="ch_infog33(6);">스마일프로</a>
	        				</li>
                            <li>
			...
			<div class="surgery_kind">
			  <div class="inner">
			    <ul class="surgery_kind_ul">
			      <li class="surgery_kind_ul_li01">
			        <ul class="surgery_kind_ul_inner surgery_kind_ul_inner02">
			          <li> <a href="sub.asp?lasik=B103"> <img src="image/main/1.jpg" alt="" >
			            <div class="txt_wrap">
			              <p class="txt01" data-aos="fade-up"
                                        data-aos-duration="1000" data-aos-delay="200">신세계스마일프로</p>
			              <p class="txt02 pb6" data-aos="fade-up"
                                        data-aos-duration="1000" data-aos-delay="300">가장 완벽한 스마일수술</p>
			              <!-- <p class="txt02 txt03" data-aos="fade-up"
                                        data-aos-duration="1000" data-aos-delay="600">신세계 스마일 프로</p> -->
		              </div>
			            </a> </li>
			          <li> <a href="sub.asp?lasik=B101"> <img src="image/main/2.jpg" alt="" >
			            <div class="txt_wrap">
			              <p class="txt01" data-aos="fade-up"
                                        data-aos-duration="1000" data-aos-delay="200">신세계스마일</p>
			              <p class="txt02 pb8" data-aos="fade-up"
                                        data-aos-duration="1000" data-aos-delay="300">베스트 스킬 닥터의 노하우</p>
			              <!--  <p class="txt02 txt03 tar" data-aos="fade-up"
                                        data-aos-duration="1000" data-aos-delay="600">신세계 스마일 라식</p> -->
		              </div>
			            </a> </li>
		            </ul>
		          </li>
			      <li>
			        <ul class="surgery_kind_ul_inner">
			          <li> <a href="sub.asp?lasik=C101"> <img src="image/main/surgerybg2.jpg" alt="" >
			            <div class="txt_wrap">
			          ...
			          <li> <a href="sub.asp?lasik=D101"> <img src="image/main/surgerybg3.jpg" alt="" >
			            <div class="txt_wrap">
			          ...
			          <li> <a href="sub.asp?lasik=E101"> <img src="image/main/surgerybg4.jpg" alt="" >
			            <div class="txt_wrap">
			          ...
			          <li> <a href="sub.asp?lasik=F103"> <img src="image/main/surgerybg5.jpg" alt="" >
			            <div class="txt_wrap">
