<div class="sub_join">
  <div class="inner">
	...
	<div class="input_form">
	  <form name="frmRequestForm" method="post" onsubmit="return frmRequestForm_Submit(this);" action="/main01/J10/insert.asp" enctype="multipart/form-data">
	  <table>
		<tbody> 
		  <tr>
			<th>아이디</th>
...
$(document).ready(function(){
	...
	$("#BtnIdchk1").click(function(e){
	  ...
	  ajaxObjects[ajaxIndex].requestFile = "/main01/J10/checking.asp";
