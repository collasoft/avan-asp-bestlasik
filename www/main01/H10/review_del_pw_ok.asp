...
Call jsAlertMsgUrl("삭제 되었습니다", "/main01/sub.asp?lasik=H101&gubun=a&intSeq="&request.QueryString("intSeq")&"&page="&request.QueryString("page")&"&gum1="&request.QueryString("gum1")&"&gum2="&request.QueryString("gum2"))
'+++++++[6]_End
%>