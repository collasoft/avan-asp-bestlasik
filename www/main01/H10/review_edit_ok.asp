...
Dim esql, ers
	esql = "select * from review where intSeq = "& request.QueryString("intSeq")
...
Call update.setdataAdd("r_eyeforce1", update.getFormValue("r_eyeforce1-1") & "/" & update.getFormValue("r_eyeforce1-2"))
Call update.setdataAdd("r_eyeforce2", update.getFormValue("r_eyeforce2-1") & "/" & update.getFormValue("r_eyeforce2-2"))
...
Call jsAlertMsgUrl("수정 되었습니다", "/main01/sub.asp?lasik=H102&gubun=a&intSeq="&request.QueryString("intSeq")&"&page="&request.QueryString("page")&"&gum1="&request.QueryString("gum1")&"&gum2="&request.QueryString("gum2"))
'+++++++[6]_End
%>