...
Call insert.setdataAdd("r_inputtime", now())
Call insert.setdataAdd("r_eyeforce1", insert.getFormValue("r_eyeforce1-1") & "/" & insert.getFormValue("r_eyeforce1-2"))
Call insert.setdataAdd("r_eyeforce2", insert.getFormValue("r_eyeforce2-1") & "/" & insert.getFormValue("r_eyeforce2-2"))
...
Call jsAlertMsgUrl("등록되었습니다", "/main01/sub.asp?lasik=H101&gubun=a")
'+++++++[6]_End
%>