...
<link rel="stylesheet" href="_css/main02.css?ver=20200324" />
...
<script type="text/javascript">
	...
	window.addEventListener("resize",function(){
		...
		$(".slide_wrap").slick("slickSetOption","slidesToShow","1",false);
		}else{
...
function logingogo(intint)
{
	...
	{
		location.href = "sub.asp?eye=J101&intSeq="+ intint;
	}
}
//-->
</script>
...
function popuplayer1(){
  ...
  if ( notice_getCookie('popup_3') != 'done' ){
...
<%
  ...
  sqlw = "SELECT * FROM popup where intSeq = 3"
...
<%If Len(session("useridid")) = 0 then%>
			<li class="q_login"><a href="sub.asp?eye=J101">로그인</a></li>
			<li class="q_join"><a href="sub.asp?eye=I101">회원가입</a></li>
<%else%>
			<li class="q_logout"><a href="/main02/J10/logout.asp">로그아웃</a></li>
<%End if%>
			<li class="q_reserve"><a href="sub.asp?eye=H106">진료예약</a></li>
			<li class="q_counseling"><a href="sub.asp?eye=H102">1:1상담</a></li>
			<li class="q_event"><a href="sub.asp?eye=F101">이벤트</a></li>
			<li class="q_sms"><a title="모바일위치전송" class="btn-circle" onclick="window.open('http://www.one-shot.co.kr/simplem/simplem.asp?simplem_client=MTQwNDE=', '', 'width=400,height=636, scrollbars=no,toolbar=no,status=no')" href="#none">문자로<br>주소받기</a></li>
				...
				<div class="visual_wrap">
					<div class="visual"> 
						<section class="lazy slider" data-sizes="50vw">
							<!--<div class="slide05">
								<a href="/main02/sub.asp?eye=F104&intSeq=327&page=&gum1=&gum2=">
									<img class="visual_pc" src="image/main/main01_visualImg05_20200316.jpg">
									<img class="visual_m" src="image/main/m_main01_visualImg05_20200316.jpg">
								</a>
							</div>-->
							<div class="slide01">
								<a href="/main02/sub.asp?eye=C102">
									<img class="visual_pc" src="image/main/main02_visualImg01.jpg">
									<img class="visual_m" src="image/main/m_main02_visualImg01.jpg">
									<div class="txt_box">
							...
							<div class="slide02">
								<a href="/main02/sub.asp?eye=B102">
									<img class="visual_pc" src="image/main/main02_visualImg02.jpg">
									<img class="visual_m" src="image/main/m_main02_visualImg02.jpg">
									<div class="txt_box">
										<strong>칼이 필요없는<br/>레이저 백내장 수술</strong>
										<!--<p>4無(통증, 출혈, 봉합, 입원) 시스템</p>-->
										<button type="button" class="more_btn">자세히 보기</button>
									</div>
								</a>
							</div>
							<div class="slide03">
								<a href="/main02/sub.asp?eye=A102">
									<img class="visual_pc" src="image/main/main02_visualImg03.jpg">
									<img class="visual_m" src="image/main/m_main02_visualImg03.jpg">
									<div class="txt_box">
										<strong>보다, 신세계</strong>
										<p>분야별 안과전문의가<br> 새로운 세계를 보여드리겠습니다.</p>
										<button type="button" class="more_btn">의료진 보기</button>
									</div>
								</a>
							</div>
							<div class="slide04">
								<a href="/main02/sub.asp?eye=B105">
									<img class="visual_pc" src="image/main/main02_visualImg04.jpg">
									<img class="visual_m" src="image/main/m_main02_visualImg04.jpg">
									<div class="txt_box">
										<strong>다양한 다초점렌즈 보유</strong>
										<p>시너지 / 테크니스 / 리사트리 / 프리시존 / 파인비전 / 팬옵틱스<br>심포니 / SBL / 렌티스 엠플러스 / 버니 / 토비 / 아이핸스</p>
										<button type="button" class="more_btn">자세히 보기</button>
									</div>
								</a>
							</div>
							<div class="slide05">
								<a href="/main02/sub.asp?eye=B105">
									<img class="visual_pc" src="image/main/main02_visualImg05_200424.jpg">
									<img class="visual_m" src="image/main/m_main02_visualImg05.jpg">
									<div class="txt_box">
										<strong>리사트리 5,000례 돌파</strong>
										<p>노안·백내장 다초점 인공수정체<br>독일 칼자이스, 자이언트 리사트리 인증</p>
										<button type="button" class="more_btn">자세히 보기</button>
								</a>
							</div>    
						</section>
				...
				<!--<div class="review_wrap"> 
					<div class="inner"> 
						<div class="title_wrap">
							<h2 class="title">BEST 후기</h2>
							<h4 class="title_txt">신세계안과에서 수술한 고객님들의 후기입니다.</h4>
							<a href="sub.asp?eye=G101&gubun=a" class="more">더보기</a>
						</div>
						<div class="slide_wrap">
						    
							<%
							  Dim sql2, rs2, a
							  sql2 = "SELECT top 3 * FROM review2 WHERE gubun = 'a' order by intSeq desc"
							...
							%>
								  <div>
									<div class="review_list"> 
										<a href="sub.asp?eye=G102&intSeq=<%=rs2("intSeq")%>&gubun=a">
											<div class="img"><%If Len(rs2("img1")) > 0 then%><img src="/upload/review/<%=Split(rs2("img1"),":")(0)%>" alt=""/><%End if%></div>
											<div class="txt_wrap">
												<p class="txt01">[<%=review_gubun(rs2("r_bunryu"))%>] &nbsp; 수술 후 시력 <%=rs2("r_eyeforce2")%> &nbsp; <%=Replace(Left(rs2("r_inputtime"),10),"-",".")%></p>
												<p class="txt02"><%=Left(rs2("r_title"),10)%>...</p>
												<p class="txt03"><%=Left(RemoveHTML(rs2("r_contents")),90)%>...</p>
											</div>
											<div class="more_box">자세히 보기</div>
										</a>
									</div>
								  </div>
							<%
						...
						<a href="sub.asp?eye=G101&gubun=a" class="more02">더보기</a>
					</div>
				</div>-->
				<div class="main_review">
					<div class="inner">
						<div class="titArea">
							...
							<ul class="tabs">
								<li>
		        					<a href="#tab1" onClick="ch_infog33(1);">노안·백내장</a>
		        				</li>
		        				<li>
		        					<a href="#tab2" onClick="ch_infog33(2);">백내장</a>
		        				</li>		        				
		        				<li>
		        					<a href="#tab3" onClick="ch_infog33(3);">안성형</a>
		        				</li>
		        			</ul>
						</div>
						<div class="conArea">
							<div class="tab_container">
								...
								<%
								  ...
								  For jj = 1 To 4
									...
									If jj = 1 Then
									  r_bunryu = "r_bunryu = 'b' and"
									  bunryu = "b"
									ElseIf jj = 2 Then
									  r_bunryu = "r_bunryu = 'a' and"
									  bunryu = "a"
									ElseIf jj = 3 Then
									  r_bunryu = "r_bunryu = 'c' and"
									  bunryu = "c"
									ElseIf jj = 4 Then
								...
								<div id="realstory<%=jj%>" <%If jj <> 1 then%>style="display:none;"<%End if%>>
					            	...
					            	<ul class="conArea_ul">
									    <li class="video">
										   <%
											  sql2 = "SELECT top 5 * FROM review2 where "&r_bunryu&" movie_yn = 'Y' and gubun = 'a' and best = 'Y' order by r_inputtime desc"
											  set rs2 = dbconn.execute(sql2)
											  if rs2.eof Then
										   ...
										   <div>
											  <div>  
												<div>
													...
													<%If rs2("img1") <> "" then%><a href="javascript:logingogo('<%=rs2("intSeq")%>');"><img src="/upload/review/<%=Split(rs2("img1"),":")(0)%>" style="width:100%;" /></a><%End if%>
													<%else%>
													<%If rs2("img1") <> "" then%><a href="/main02/sub.asp?eye=G102&intSeq=<%=rs2("intSeq")%>&gubun=a"><img src="/upload/review/<%=Split(rs2("img1"),":")(0)%>" style="width:100%;" /></a><%End if%>
													<%End if%>
					            		...
					            		<li class="photo">
										    <%
											  ...
											  sql2 = "SELECT top 2 * FROM review2 where "&r_bunryu&" movie_yn <> 'Y' and gubun = 'a' order by best desc, r_inputtime desc"
											  set rs2 = dbconn.execute(sql2)
											...
											%>
											<div>
												<a href="/main02/sub.asp?eye=G102&intSeq=<%=rs2("intSeq")%>&gubun=a">
													<div class="img">
														<%If Len(rs2("img1")) > 0 then%>
														<img src="/upload/review/<%=Split(rs2("img1"),":")(0)%>" alt="" style="width:316px;height:316px;">
														<%else%>
														<img src="/upload/logologo10.jpg" alt="" style="width:316px;height:316px;">
														<%End if%>
													</div>
													<div class="txt">
														<p class="tit"><span>[<%=r_bunryu_name%>]</span><%=Left(rs2("r_title"),12)%>..</p>
					            	...
					            	<button type="button" class="best_moreBtn" onclick="location.href='/main02/sub.asp?eye=G101&gubun=a&bunryu=<%=bunryu%>';">+ 더보기</button>
					            </div>
								<%next%>
				...
				<div class="youtube_banner">
					...
					<div class="youtube_banner_list">
						<div class="inner">
							<ul>
								<%
								  sql2 = "SELECT top 4 * FROM youtube1 where you_main = 'Y' and gubun = 'no' order by intSeq desc"
								  set rs2 = dbconn.execute(sql2)
								  if rs2.eof Then
								%>
								<li></li>
					...
					<div class="inner">
						<ul>
							<li data-aos="fade-up" data-aos-duration="700">
								<a href="sub.asp?eye=B102">
									<img src="image/main/result_img3.png" alt="" />
									<div class="txt_wrap">
										<p class="name" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">노안·백내장</p>
										<p class="txt" data-aos="fade-up"	data-aos-duration="1000" data-aos-delay="200">노안과 백내장을 동시에 해결</p>
									</div>
								</a>
							</li>
							<li data-aos="fade-up" data-aos-duration="900">
								<a href="sub.asp?eye=E109">
									<img src="image/main/result_img4.png" alt=""/>
									<div class="txt_wrap">
										<p class="name" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">안종합질환</p>
										<p class="txt" data-aos="fade-up"	data-aos-duration="1000" data-aos-delay="200">안과전문의 분야별 진료</p>
									</div>
								</a>
							</li>
							<li>
								<a href="sub.asp?eye=B101">
									<img src="image/main/result_img1.png" alt=""/>
									<div class="txt_wrap">
										<p class="name" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">백내장</p>
										<p class="txt" data-aos="fade-up"	data-aos-duration="1000" data-aos-delay="200">20년의 노하우로<br>
										완벽함을 담다</p>
									</div>
								</a>
							</li>
							<li data-aos="fade-up" data-aos-duration="500">
								<a href="sub.asp?eye=D101">
									<img src="image/main/result_img2.png" alt=""/>
									<div class="txt_wrap">
										<p class="name" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">눈성형</p>
										<p class="txt" data-aos="fade-up"	data-aos-duration="1000" data-aos-delay="200">안성형 전문의의<br>
										맞춤형 디자인</p>
									</div>
								</a>
							</li>
				...
				<div class="staff_wrap"> 
					<div class="inner">
						...
						<div class="staff_list">
							...
							%>
							<div>
								<a href="sub.asp?eye=A106&staff=<%=rs2("intSeq")%>#info">
									<ul class="staff_box">
										<li>
											<div class="intro_l">
										...
										<li><%If Len(rs2("img2")) > 0 then%><img src="/upload/staff/<%=Split(rs2("img2"),":")(0)%>" style="" alt=""/><%End if%></li>
									</ul>
								</a>
							</div>
							<%
				...
				<div class="m_news_wrap">
					<div class="inner notice_icons">
						<ul>
							...
							<li>
								<a href="sub.asp?eye=F101">
									<i></i>
									<p>이벤트</p>
								</a>
							</li>
							<li>
								<a href="sub.asp?eye=F105">
									<i></i>
									<p>보도자료</p>
								</a>
							</li>
							<li>
								<a href="sub.asp?eye=F109">
									<i></i>
									<p>빛창공모전</p>
								</a>
							</li>
					...
					<div class="inner notice_events">
						...
						%>
							<div class="thumbnail">
								<%If Len(rs2("thumbnail")) > 0 then%>
									<a href="sub.asp?eye=F104&intSeq=<%=rs2("intSeq")%>"><img src="/upload/notice/<%=Split(rs2("thumbnail"),":")(0)%>" alt="" style="width:100%;; height:405px;"/></a>
								<%Else%>
									<a href="sub.asp?eye=F104&intSeq=<%=rs2("intSeq")%>"><img src="/upload/logologo9.jpg" alt="" style="width:100%;; height:405px;"/></a>
								<%End if%>
							</div>
							<!--li>
							  <a href="sub.asp?eye=F104&intSeq=<%=rs2("intSeq")%>"><%=Left(rs2("n_title"),18)%>...</a>
						...
						<ul class="list">
							...
							%>
							<li>
							  <a href="sub.asp?eye=F104&intSeq=<%=rs2("intSeq")%>"><%=rs2("n_title")%></a>
							  <span class="day"><%=Left(rs2("n_inputtime"),10)%></span>
							</li>
							<%
								rs2.MoveNext
				...
				<div class="news_wrap"> 
					<div class="inner">
						...
						<ul class="news_box">
							<li>
								<div class="news_list">
									<p class="list_title">공지사항<a href="sub.asp?eye=F103">more</a></p>
									<ul class="list">
										<%
										  sql2 = "SELECT top 5 * FROM notice order by intSeq desc"
										  set rs2 = dbconn.execute(sql2)
								...
								<div class="news_list">
									<p class="list_title">이벤트<a href="sub.asp?eye=F101">more</a></p>
									<%
									  ...
									  Else
										...
										Do Until rs2.EOF
									%>
								  <div class="img"><%If Len(rs2("img1")) > 0 then%><a href="sub.asp?eye=F102&intSeq=<%=rs2("intSeq")%>"><img src="/upload/event/<%=Split(rs2("img1"),":")(0)%>" alt=""/></a><%End if%></div>
								  <div class="txt">
									<a href="sub.asp?eye=F102&intSeq=<%=rs2("intSeq")%>"><%=Left(rs2("e_title"),18)%>...</a>
								...
								<div class="news_list">
									<p class="list_title">보도자료<a href="sub.asp?eye=F105">more</a></p>
									<ul class="list">
										<%
										...
										%>
										<li>
										  <a href="sub.asp?eye=F106&intSeq=<%=rs2("intSeq")%>"><%=Left(rs2("p_title"),18)%>...</a>
						 				...
						 				<table>
						 					...
						 					<tr>
						 						...
						 						<td>
						 							...
						 							<input type="text" class="callNum" name="besttel2" id="besttel2" maxlength="4" onkeydown="return onlyNumber(event);" onkeyup="removeChar(event);" />
						 							<span class="textline"></span>
						 							<input type="text" class="callNum" name="besttel3" id="besttel3" maxlength="4" onkeydown="return onlyNumber(event);" onkeyup="removeChar(event);" />
						 						</td>
						 					</tr>
						 					<tr>
						 						<th>진료항목</th>
				...
				<div class="main_notice">
					<div class="inner">
						<ul>
							...
							<li class="boxArea">
								<div class="map">
									<a href="/main02/sub.asp?eye=A104">
								...
								<div class="call">
									...
									<ul>
										<li>
											<i></i>
											<a href="sub.asp?eye=H106" class="bg">
												진료예약
											</a>
										</li>
										<li>
											<i></i>
											<a href="sub.asp?eye=H102" class="bg">
												진료상담
											</a>
										</li>
										<li>
				...
				<div id="A_Footer">
					<div class="sns_menu"> 
						<ul>
							...
							<li><a href="https://cafe.naver.com/mrchakw" target="_blank"></a></li>	
						</ul>
					</div>
