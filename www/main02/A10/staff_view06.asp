        ...
        <div id="A_Container">
			...
			<div class="sub_content">
				...
				<div class="staff"> 
					<div class="inner">
					<ul class="staff_view">
						<li><img src="image/sub/staffview_img06.png" alt=""/></li>
						<li>
							<div class="title_wrap">
								<p class="title">각막/안성형/백내장 안과전문의</p>
								<p class="name"><span>오한진</span> 원장</p>
							</div>
							...
							<div class="intro">
								...
								<ul> 
									<li>현)전남대학교 의과대학 외래교수</li>
									<li>전남대학교병원 인턴/전공의 과정 수료</li>
									<li>전남대학교대학원 석사/박사</li>
									<li>전남대학교병원 임상교수</li>
									<li>한국외안부학회 정회원</li>
									<li>한국백내장 굴절수술학회 정회원</li>
									<li>한국안감염학회 정회원</li>
									<li>한국건성안학회 정회원</li>
								</ul>
							</div>
