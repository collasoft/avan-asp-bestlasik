        ...
        <div id="A_Container">
			...
			<div class="sub_content">
				...
				<div class="staff"> 
					<div class="inner">
					<ul class="staff_view">
						<li><img src="image/sub/staffview_img05.png" alt=""/></li>
						<li>
							<div class="title_wrap">
								<p class="title">안성형/시력교정/백내장 안과전문의</p>
								<p class="name"><span>박종서</span> 원장</p>
							</div>
							...
							<div class="intro">
								...
								<ul> 
									<li>차의과학대학교 졸업</li>
									<li>차의과학대학교 분당차병원 전공의 과정 수료</li>
									<li>분당차병원 성형안과 임상교수</li>
									<li>대한안과학회(KOS) 정회원</li>
									<li>대한성형안과학회(KSOPRS) 정회원</li>
