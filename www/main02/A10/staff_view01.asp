        ...
        <div id="A_Container">
			...
			<div class="sub_content">
				...
				<div class="staff"> 
					<div class="inner">
					<ul class="staff_view">
						<li><img src="image/sub/staffview_img01.png" alt=""/></li>
						<li>
							<div class="title_wrap">
								<p class="title">시력교정/백내장 안과전문의</p>
								<p class="name"><span>김재봉</span> 대표원장</p>
							</div>
							...
							<div class="intro">
								...
								<ul > 
									...
									<li>전남대학교 대학원 석사</li>
									<li>전남대학교 대학원 박사</li>
									<li>국군 광주 병원(통합병원) 안과과장</li>
									<li>한국 굴절 수술학회 정회원</li>
									<li>전 서남대학교 안과 외래교수</li>
									<li>전 광주 안과 대표원장</li>
									<li>대학민국 100대 명인선정</li>
									<li>전 서남대학교 안과 외래교수</li>
									<li>전 광주안과 대표원장</li>
									<li>연세대학교 의과대학원 석박사 통합 과정</li>
									<li>한국 백내장 굴절 수술학회 정회원</li>
									<li>한국 포도막 학회 정회원</li>
									<li>한국 망막 학회 준회원</li>
									<li>Khairabad Netra eye hospital 연수</li>
								</ul>
							</div>
						</li>
					</ul>
