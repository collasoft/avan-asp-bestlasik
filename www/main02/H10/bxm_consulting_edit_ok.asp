...
Else 
	...
	Call jsAlertMsgUrl("수정 되었습니다.", "/main02/sub.asp?eye=H103&seq="&request.QueryString("seq")&"&nPage="&request.QueryString("nPage")&"&gum1="&request.QueryString("gum1")&"&gum2="&request.QueryString("gum2"))
End if
%>