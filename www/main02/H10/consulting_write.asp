...
<div class="consulting">
  <div class="inner">
	...
	<div class="input_form">
	  <form name="frmRequestForm" method="post" onSubmit="return frmRequestForm_Submit(this);" action="/main02/H10/consulting_write_ok.asp" enctype="multipart/form-data">
	  <table>
		<tbody> 
		  <tr>
			<th>작성자</th>
	  ...
	  <div class="subbtn_wrap">
		<input type="button" value="목록" class="btn01" onclick="self.location.href='?eye=H102'" /><input type="button" value="등록" class="btn02" onClick="mobConv();this.form.onsubmit();" />
	  </div>	
	  </form>
	</div>
  </div>
