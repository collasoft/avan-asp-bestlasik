<div class="diagnosis">
  <div class="inner">
	...
	<div class="input_form">
	  <form name="frmRequestForm" method="post" onSubmit="return frmRequestForm_Submit(this);" action="/main02/H10/diagnosis_write_ok.asp" enctype="multipart/form-data">
	  <table>
		<tbody> 
		  <tr>
			<th>진료여부</th>
		  ...
		  <tr>
			...
			<td class="call"><select name="b_phone1" id="b_phone1">
			  ...
			  </select></select><input type="text" name="b_phone2" maxlength="4" onkeydown="return onlyNumber(event);" onkeyup="removeChar(event);" /><input type="text" name="b_phone3" maxlength="4" onkeydown="return onlyNumber(event);" onkeyup="removeChar(event);" /></td>
		  </tr>
		  <tr>
			<th>진료구분</th>
			<td class="call">
			  <select name="b_bunryu" id="b_bunryu">
				...
				<option value="안종합질환">안종합질환</option>
