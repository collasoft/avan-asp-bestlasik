...
Call update.setUploadFolder("/upload/counsel2")
...
Call update.settablename("counsel2")
...
Call jsAlertMsgUrl("수정 되었습니다.", "/main02/sub.asp?eye=H103&intSeq="&request.QueryString("intSeq")&"&page="&request.QueryString("page")&"&gum1="&request.QueryString("gum1")&"&gum2="&request.QueryString("gum2"))
