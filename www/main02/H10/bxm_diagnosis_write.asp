...
//			$("#cmonth").val(thsday.substr(0,4));
			...
			$.ajax({
				type: "POST",
				url: "/main02/H10/bxm_ajax_reserve.asp",
				dataType: "html",
...
<form name="frmRequestForm" method="post" onSubmit="return frmRequestForm_Submit(this);" action="/main02/H10/bxm_diagnosis_write_ok.asp">
...
<%Next%>
												...
												<span class="notice_cal" style="display:none;">*선택하신 시간은 마감되었습니다.</span>
											</td>
										</tr>
										<tr>
											<th>진료여부</th>
