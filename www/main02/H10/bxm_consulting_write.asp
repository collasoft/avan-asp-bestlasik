<div class="consulting">
  <div class="inner">
	...
	<div class="input_form">
	  <form name="frmRequestForm" method="post" onSubmit="return frmRequestForm_Submit(this);" action="/main02/H10/bxm_consulting_write_ok.asp">
	  <input type="hidden" name="MODE" value="INSERT">
	  <input type="hidden" name="gubun" value="main02">
	  <table>
		<tbody> 
		  <tr>
			<th>작성자</th>
