  ...
  <div class="inner">
	<p class="list_txt">
      ...
      <div class="search_wrap">
		<form name="list_search" id="list_search" method="post" action="?eye=F103">
    ...
    <table class="basic_list">
	  ...
	  <tr>
		<td><%=pagei%></td>
		<td><a href="?eye=F104&intSeq=<%=rs2("intSeq")%>&page=<%=request("page")%>&gum1=<%=request("gum1")%>&gum2=<%=request("gum2")%>"><%=rs2("n_title")%></a></td>
