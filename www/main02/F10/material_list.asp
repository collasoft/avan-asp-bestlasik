  ...
  <div class="inner">
	<p class="list_txt">
      ...
      <div class="search_wrap">
	    <form name="list_search" id="list_search" method="post" action="?eye=F105">
	...
	<div class="image_list">
	  <a href="?eye=F106&intSeq=<%=rs2("intSeq")%>&page=<%=request("page")%>&gum1=<%=request("gum1")%>&gum2=<%=request("gum2")%>">
	    <div class="image">
	    ...
	    <div class="txt_box">
		  ...
		  <p class="txt02"><%=Left(RemoveHTML(rs2("p_contents")),280)%></p>
