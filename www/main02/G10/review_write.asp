...
따라 처벌을 받을 수 있음을 알려드립니다.
	...
	<div class="input_form">
	  <form name="frmRequestForm" method="post" onSubmit="return frmRequestForm_Submit(this);" action="/main02/G10/review_write_ok.asp" enctype="multipart/form-data">
		<table>
			<colgroup>
			...
			<tbody> 
				...
				<tr>
					...
					<option value="">선택</option>
					  <option value="a">백내장</option>
					  <option value="b">노안 ∙ 백내장</option>
					  <option value="c">안성형</option>
					  <option value="d">안구종합질환</option>
					</select></td>
				</tr>
				<tr>
					<th>원장</th>
				...
				<tr>
					<th>상담사</th>
					<td><input type="text" name="people2" maxlength="20" class="input01 w20"></td>
				</tr>	
				<tr> 
					<th>수술 전<br class="m_block"> 시력</th>
					<td class="eye"><input type="text" name="r_eyeforce1" maxlength="10" /></td>
				</tr>
				<tr>
					<th>수술 후<br class="m_block"> 시력</th>
					<td class="eye"><input type="text" name="r_eyeforce2" maxlength="10" /></td>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" name="r_title" maxlength="100" /></td>
				</tr>
			  <!-- <tr>
				<th>비밀번호</th>
				...
				<tr>
					<th>내용</th>
					<td colspan="3"><%call Editor("b_text","")%></td>
				</tr>
