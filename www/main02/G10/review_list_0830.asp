...
<div class="consulting"> 
  <div class="inner">
	...
	<ul class="sub_tab mb50"> 
	  ...
	  <li <%If Request.QueryString("bunryu") = "a" Then%>class="on"<%End if%>><a href="?eye=<%=Request("eye")%>&gubun=<%=Request.QueryString("gubun")%>&bunryu=a">백내장</a></li>
	  ...
	  <li <%If Request.QueryString("bunryu") = "Y" Then%>class="on"<%End if%>><a href="?eye=<%=Request("eye")%>&gubun=<%=Request.QueryString("gubun")%>&bunryu=Y">베스트</a></li>
