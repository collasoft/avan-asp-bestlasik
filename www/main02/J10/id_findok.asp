...
<div class="sub_join">
	...
	<div class="subbtn_wrap">
		<input type="button" value="메인으로" class="btn01" onclick="location.href='/main02';" /><input type="button" value="비밀번호찾기" class="btn01" onclick="location.href='?eye=J104';" /><input type="button" value="로그인" class="btn02" onclick="location.href='?eye=J101';" />
	</div>
