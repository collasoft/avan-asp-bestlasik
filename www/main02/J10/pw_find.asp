<div class="sub_join">
  <div class="inner">
	<div class="top_tabwrap mb50"> 
	  <ul> 
		<li><a href="?eye=J102">아이디찾기</a></li>
		<li class="on"><a href="?eye=J104">비밀번호찾기</a></li>
	  </ul>
	</div>
	<div class="top_txt02"> 
	...
	<div class="input_form">
	  <form name="loginform" onsubmit="return submit_check(this);" action="/main02/J10/pw_findok.asp" method="post">
	  <table>
		<tbody> 
		  <tr>
			<th>아이디</th>
