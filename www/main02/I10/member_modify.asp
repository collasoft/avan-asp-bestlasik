...
<div class="sub_join">
  <div class="inner">
    ...
    <div class="input_form">
	  <form name="frmRequestForm" method="post" onsubmit="return frmRequestForm_Submit(this);" action="/main02/I10/update.asp" enctype="multipart/form-data">
	  <table>
		<tbody>
		  ...
		  <tr>
			...
			<td class="email">
			  ...
			  <input type="text" name="strEmail2" id="strEmail2" style="ime-mode:disabled;width:200px;" value="<%=emai(1)%>">
	  ...
	  <div class="sns_con">
		...
		<ul class="sns_login">
		  ...
		  <%  else%>
		        <li class="sns_grey"><a href="/main02/I10/sns_out.asp?sns_name=naver_token"><span></span><p>네이버 계정 연동 해제</p></a></li>
		  <%
			  End if
			Else %>
		  ...
		  <%  else%>
		        <li class="sns_grey"><a href="/main02/I10/sns_out.asp?sns_name=kakao_token"><span></span><p>카카오 계정 연동 해제</p></a></li>
		  <%
			  End if
			Else %>
	  ...
	  <p class="del_txt">회원 탈퇴 시 신세계안과에서 제공하는 각종 이벤트/혜택을 이용하실 수 없습니다. 정말 탈퇴 하시겠습니까? <a href="?eye=I105">탈퇴하기</a></p>
	  <div class="subbtn_wrap">
		<input type="button" value="취소" class="btn01" onclick="location.href='/main02';" />
...
function SNSLogin(sns){
	...
	var popup = window.open("/main02/J10/gateway.asp?sns="+sns+"&mode=sync","sns","resizable=false,width=880,height=720, top=" + top + ", left=" + left);
}
